 ...
 * @license AGPL-3.0
 */
class CRM_Fintrxn_ConfigItems_OptionValue {

  protected $_apiParams = array();

  /**
   * CRM_Fintrxn_ConfigItems_OptionValue constructor.
   */
  ...
  public function create($params) {
    ...
    try {
      ...
      throw new Exception(ts('Could not create or update option_value with name').' '.$this->_apiParams['name']
        .ts(' in option group with id').' '.$this->_apiParams['option_group_id'].' in '.__METHOD__.', '
